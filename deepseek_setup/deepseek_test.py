...
model = AutoModelForCausalLM.from_pretrained(
    "deepseek-ai/DeepSeek-R1-Distill-Qwen-7B", torch_dtype="auto", device_map="auto"
)
...
# default processer
processor = AutoProcessor.from_pretrained("deepseek-ai/DeepSeek-R1-Distill-Qwen-7B")
